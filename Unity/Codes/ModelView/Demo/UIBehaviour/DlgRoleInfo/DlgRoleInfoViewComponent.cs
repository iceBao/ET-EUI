		...
		public UnityEngine.UI.Text E_CombatEffectivenessText
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_CombatEffectivenessText = UIFindHelper.FindDeepChild<UnityEngine.UI.Text>(this.uiTransform.gameObject,"BackGround/TopBackGround/CombatEffectiveenessGroup/E_CombatEffectiveness");
     			}
