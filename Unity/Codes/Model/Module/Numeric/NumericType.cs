namespace ET
{
    ...
    public static class NumericType
    {
	    ...
	    public const int MaxMpBase = MaxHp * 10 + 1;
	    public const int MaxMpAdd = MaxHp * 10 + 2;
	    public const int MaxMpPct = MaxHp * 10 + 3;
	    public const int MaxMpFinalAdd = MaxHp * 10 + 4;
	    public const int MaxMpFinalPct = MaxHp * 10 + 5;
